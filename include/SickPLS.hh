...
/* Macro definitions */
#define DEFAULT_SICK_PLS_SICK_BAUD                                       (B500000)  ///< Initial baud rate of the PLS (whatever is set in flash)
...
#define DEFAULT_SICK_PLS_NUM_TRIES                                           (1)  ///< The max number of tries before giving up on a request
